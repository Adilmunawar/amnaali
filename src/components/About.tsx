...
export const About = () => {
  ...
  return <section id="about" className="py-20 bg-gradient-to-br from-slate-800 via-purple-900 to-slate-800 relative overflow-hidden">
      {/* Animated Background Particles */}
      <div className="absolute inset-0">
        {[...Array(50)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-purple-400 rounded-full" initial={{
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        once: true
          ...
          <motion.h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent" animate={{
          ...
          <motion.p className="text-xl text-gray-400 max-w-3xl mx-auto" initial={{
          opacity: 0,
          scale: 0.8
        }} whileInView={{
          opacity: 1,
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          once: true
            ...
            return <motion.div key={achievement.label} variants={itemVariants} whileHover={{
              scale: 1.05,
              y: -10,
              rotateY: 5,
              transition: {
                ...
                stiffness: 300
                  ...
                  <motion.div className="absolute inset-0 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div className="relative z-10">
                  ...
                  duration: 0.8
                    ...
                    <motion.h4 className="text-3xl font-bold text-white mb-2" initial={{
                  opacity: 0,
                  y: 20
                }} whileInView={{
                  opacity: 1,
