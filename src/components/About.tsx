              ...
              {skills.map((skill, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="relative bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/10 group hover:border-white/20 transition-all duration-500"
                  >
