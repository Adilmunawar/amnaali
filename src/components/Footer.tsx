...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-purple-900 via-slate-900 to-indigo-900 text-white py-20 overflow-hidden">
          ...
          >
            ...
            <div className="space-y-3">
              {["Home", "About", "Tools", "Portfolio", "Services", "Contact"].map((link, index) => (
                ...
                >
                  <motion.span
                    className="absolute left-0 w-0 h-0.5 bg-cyan-400 bottom-0 group-hover:w-full transition-all duration-300"
                  />
                  {link}
                </motion.a>
              ))}
        ...
        >
          ...
          >
            ...
            <motion.img 
              ...
              className="mx-auto h-24 object-contain filter brightness-0 invert opacity-90 relative z-10"
              animate={{ 
                filter: [
                  "brightness(0) invert(1) drop-shadow(0 0 10px rgba(34, 211, 238, 0.5))",
                  "brightness(0) invert(1) drop-shadow(0 0 20px rgba(168, 85, 247, 0.7))",
                  "brightness(0) invert(1) drop-shadow(0 0 10px rgba(34, 211, 238, 0.5))"
                ]
              }}
              transition={{ 
          ...
          >
            ...
            >
              ...
              by{" "}
              <motion.span
                className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent font-bold text-xl"
                whileHover={{ scale: 1.1 }}
              >
                Amna Ali
              </motion.span>
