...
export const Hero = () => {
  ...
  return <section id="home" className="relative min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 overflow-hidden flex items-center justify-center">
      {/* Enhanced Background */}
      ...
      return <motion.div key={index} className="absolute text-purple-400/30" style={{
        ...
        ease: "easeOut"
          ...
          delay: 1.8
            ...
            scale: 0.95
              ...
              <motion.div className="absolute -inset-1 bg-gradient-to-r from-cyan-600 via-purple-600 to-pink-600 rounded-3xl blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" animate={{
              rotate: [0, 360]
            }} transition={{
              duration: 3,
              repeat: Infinity,
            ...
            scale: 0.95
              ...
              <motion.div className="relative bg-white/10 backdrop-blur-xl border border-white/20 px-8 py-4 rounded-3xl overflow-hidden" whileHover={{
