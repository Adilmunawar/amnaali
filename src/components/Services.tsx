...
export const Services = () => {
  ...
  return (
    <section id="services" className="py-32 bg-gradient-to-br from-slate-950 via-purple-950 to-indigo-950 relative overflow-hidden">
      {/* Advanced Background */}
      <div className="absolute inset-0">
        ...
        <motion.div 
          ...
          animate={{
            background: [
              "radial-gradient(circle at 20% 50%, rgba(139, 92, 246, 0.15) 0%, transparent 70%)",
              "radial-gradient(circle at 80% 50%, rgba(236, 72, 153, 0.15) 0%, transparent 70%)",
              "radial-gradient(circle at 50% 20%, rgba(6, 182, 212, 0.15) 0%, transparent 70%)",
              "radial-gradient(circle at 20% 50%, rgba(139, 92, 246, 0.15) 0%, transparent 70%)"
            ]
          }}
          transition={{
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-4 bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl px-8 py-4 mb-8"
            whileHover={{ scale: 1.05 }}
          >
            <Crown className="w-8 h-8 text-violet-400" />
            <span className="text-violet-400 font-semibold text-lg">Premium Services</span>
          </motion.div>
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-white/10 via-white/5 to-transparent backdrop-blur-2xl rounded-3xl p-8 border border-white/20 overflow-hidden h-full">
                  ...
                  <div className="relative z-10">
                    <motion.h3 
                      className="text-2xl font-bold text-white mb-4 group-hover:text-violet-400 transition-colors"
                      whileHover={{ x: 5 }}
                    >
                      {service.title}
                    </motion.h3>
